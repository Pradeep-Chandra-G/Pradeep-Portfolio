...
const Contact = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      const existingScript = document.querySelector('script[src="https://unpkg.com/@lottiefiles/dotlottie-wc@0.7.1/dist/dotlottie-wc.js"]');
      if (existingScript) {
        ...
        >
          <motion.div className="modal success-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-content">
              <dotlottie-wc 
                src="https://assets2.lottiefiles.com/private_files/lf30_4dfb546p.json" 
                speed="1" 
                style="width: 300px; height: 300px; max-width: 80vw; max-height: 300px;" 
                mode="forward" 
                loop 
                autoplay>
              </dotlottie-wc>
      ...
      {error && (
        ...
        >
          <motion.div className="modal error-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-content">
              <dotlottie-wc 
                src="https://lottie.host/617ca74c-825a-4ec2-b31e-74b99a2c8fad/MQm2vHNJYC.json" 
                speed="1" 
                style="width: 250px; height: 250px; max-width: 80vw; max-height: 250px;" 
                mode="forward" 
                loop 
                autoplay>
              </dotlottie-wc>
