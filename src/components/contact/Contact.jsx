        ...
        >
          <motion.div className="modal success-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-content">
              <dotlottie-wc 
                src="https://lottie.host/4dfb546p-e9b7-4b8e-a4c4-d8b1e8f2a3c4/4yXzK9mZ8T.json" 
                speed="1" 
                className="lottie-animation success-animation"
                mode="forward" 
                loop 
                autoplay>
              </dotlottie-wc>
      ...
      {error && (
        ...
        >
          <motion.div className="modal error-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-content">
              <dotlottie-wc 
                src="https://lottie.host/embed/d2e6c4d1-3bb8-4e8a-8e4a-9c1d2e3f4a5b/6GmXp8vZ2K.json" 
                speed="1" 
                className="lottie-animation error-animation"
                mode="forward" 
                loop 
                autoplay>
              </dotlottie-wc>
